...
cd /root
scp -r homelab-rendered "$user@pve2.$url:/home/$user"
...
scp -r homelab-rendered "$user@secsvcs.$url:/home/$user"
...
scp -r homelab-rendered "$user@websvcs.$url:/home/$user"
...
scp -r homelab-rendered "$user@vpn.$url:/home/$user"
