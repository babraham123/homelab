...
`tools/render_docs.sh <outdir>` for a readable copy, or read them in place — only
...
1. pve1 host: ssh certs, secrets and self-signed certs — [pve1](guides/pve1.md)
1. VPN setup — Headscale + Tailscale mesh: [vpn](guides/vpn.md)
1. pve1 host: acme certs — [pve1](guides/pve1.md)
1. secsvcs services — auth, monitoring, alerting: [secure_services](guides/secure_services.md)
1. VPN setup: user access — enroll personal devices: [vpn](guides/vpn.md)
1. websvcs services — web apps: [web_services](guides/web_services.md)
